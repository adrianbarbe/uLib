    ...
    <v-card class="sign-up-wrapper pa-10">
        <div class="d-flex align-center justify-center flex-column">
            ...
            <div class="mt-10 mb-2">
                ...
                <p>The uLib app stores and processes personal data that you have provided to us, in order to provide our Service. It’s your responsibility to keep your phone and access to the app secure. We therefore recommend that you do not jailbreak or root your phone, which is the process of removing software restrictions and limitations imposed by the official operating system of your device. It could make your phone vulnerable to malware/viruses/malicious programs, compromise your phone’s security features and it could mean that the uLib app won’t work properly or at all.</p>
                ...
                <div class="text-h6">Changes to This Terms and Conditions</div>
                ...
                <p>These terms and conditions are effective as of 2023-01-17.</p>

                <div class="text-h6">Contact Us</div>

                <p>If you have any questions or suggestions about our Terms and Conditions, do not hesitate to contact us at adryanbarbe@gmail.com.</p>
            </div>
        </div>
    </v-card>
</template>
